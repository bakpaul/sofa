 ...
 */
class SOFA_COMPONENT_COLLISION_DETECTION_INTERSECTION_API BaseCCDIntersection : public DiscreteIntersection
{
public:
    SOFA_ABSTRACT_CLASS(BaseCCDIntersection,DiscreteIntersection);

    Data<SReal> d_contactDistance; ///< Distance below which a contact is created
protected:
    BaseCCDIntersection();
    ~BaseCCDIntersection() override { }
public:
