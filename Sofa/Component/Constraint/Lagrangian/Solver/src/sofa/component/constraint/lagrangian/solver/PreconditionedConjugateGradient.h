 ...
 */
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_SOLVER_API PreconditionedConjugateGradient : public BuiltConstraintSolver
{
public:
    SOFA_CLASS(PreconditionedConjugateGradient, BuiltConstraintSolver);
