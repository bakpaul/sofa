...
void EulerImplicitIntegrationScheme::computePositionUpdateFromVelocity(sofa::core::MultiVecDerivId& result, const sofa::core::MultiVecDerivId& velocity)
{
    //TODO this is not in accordance to its use in VelocityIntegrationScheme where it is ecxpected to compute X and not dX being x_t - g_x(v)
...
void EulerImplicitIntegrationScheme::computeAccelerationFromVelocity(sofa::core::MultiVecDerivId& result, const sofa::core::MultiVecDerivId& velocity)
{
    sofa::simulation::common::VectorOperations vop( m_params, this->getContext() );
